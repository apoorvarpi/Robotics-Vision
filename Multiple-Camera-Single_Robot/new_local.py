...
cap1 = cv2.VideoCapture('http://172.16.15.215:8081/?action=stream?dummy=param.mjpg')
cap2 = cv2.VideoCapture('http://172.16.15.245:8081/?action=stream?dummy=param.mjpg')
